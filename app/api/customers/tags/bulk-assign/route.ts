...
import { bulkAssignCustomerTags } from "@/server/services/tags";
...
export async function POST(req: NextRequest) {
  ...
  try {
    const result = await bulkAssignCustomerTags(session, { customerIds: body.customerIds, tagIds: body.tagIds });
